...
SELECT
  ...
  campaign.primary_status_reasons AS status_reasons,
  ...
  campaign.maximize_conversion_value.target_roas_tolerance_percent_millis  AS target_roas_tolerance_percent_millis,
